...
const STATUS_CONFIG: Record<Status, { label: string; className: string }> = {
  available:             { label: 'Available',           className: 'bg-sky-500/10 text-sky-400 border-sky-500/20' },
  pending:               { label: 'Pending',             className: 'bg-amber-500/10 text-amber-400 border-amber-500/20' },
  covered:               { label: 'Covered',             className: 'bg-indigo-500/10 text-indigo-400 border-indigo-500/20' },
  ...
  booked:                { label: 'Booked',              className: 'bg-indigo-500/10 text-indigo-400 border-indigo-500/20' },
